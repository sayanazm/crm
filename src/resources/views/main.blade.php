                        ...
                        <div class="card">
                          ...
                          align-items-center">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <p class="mb-0 font-weight-medium">
                                                    <a href="#!"> </a>{{ $orderToday->start_order }} {{ $orderToday->service->name }}. Продолжительность {{ $orderToday->duration }} мин.
                                                     <a href="#!"></a></p>
                                            </div>
                                        </div>
                                        <div>
                        ...
                        <div class="card">
                          ...
                          align-items-center">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <p class="mb-0
                                font-weight-medium"><a href="#!"></a> {{ $orderTomor->start_order }} {{ $orderTomor->service->name }}. Продолжительность {{ $orderTomor->duration }} мин.
                                                    <a href="#!"></a></p>
                                            </div>
                                        </div>
                                        <div>
                        ...
                        <div class="card">
                          ...
                          align-items-center">
                                ...
                                font-weight-medium"><a href="#!"></a>
                                                    {{ $orderThirdDay->start_order }} {{ $orderThirdDay->service->name }}. Продолжительность {{ $orderThirdDay->duration }} мин.
                                                    <a href="#!"></a></p>
                                            </div>
                                        </div>
                                        <div>
                          ...
                          align-items-center">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <p class="mb-0
                                font-weight-medium"><a href="#!"></a>
                                                        {{ $orderFourthDay->start_order }} {{ $orderFourthDay->service->name }}. Продолжительность {{ $orderFourthDay->duration }} мин.
                                                        <a href="#!"></a></p>
                                                </div>
                                            </div>
                                            <div>
                          ...
                          align-items-center">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <p class="mb-0
                                font-weight-medium"><a href="#!"></a>
                                                        {{ $orderFifthDay->start_order }} {{ $orderFifthDay->service->name }}. Продолжительность {{ $orderFifthDay->duration }} мин.
                                                        <a href="#!"></a></p>
                                                </div>
                                            </div>
                                            <div>
                          ...
                          align-items-center">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <p class="mb-0
                                font-weight-medium"><a href="#!"></a>
                                                        {{ $orderSixthDay->start_order }} {{ $orderSixthDay->service->name }}. Продолжительность {{ $orderSixthDay->duration }} мин.
                                                        <a href="#!"></a></p>
                                                </div>
                                            </div>
                                            <div>
                          ...
                          align-items-center">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <p class="mb-0
                                font-weight-medium"><a href="#!"></a>
                                                        {{ $orderSeventhDay->start_order }} {{ $orderSeventhDay->service->name }}. Продолжительность {{ $orderSeventhDay->duration }} мин.
                                                        <a href="#!"></a></p>
                                                </div>
                                            </div>
                                            <div>
