                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('register.custom') }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    <input type="password" placeholder="Повторите пароль" id="password-repeat" class="form-control"
                                           name="password-repeat" required>
                                </div>
                                <div class="form-group mb-3">
                                    <input type="text" placeholder="Телефон" id="phone" class="form-control"
                                           name="phone" required>
                                    @if ($errors->has('phone'))
...
<style>
    ...
    .form {
        ...
        padding: 45px;
        text-align: center;
        box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.1), 0 2px 2px 0 rgba(0, 0, 0, 0.14);
    }
    .form input {
        font-family: "Montserrat", sans-serif;
        outline: 0;
    ...
    body {
        background: #B0C4DE; /* fallback for old browsers */
        font-family: "Montserrat", sans-serif;
